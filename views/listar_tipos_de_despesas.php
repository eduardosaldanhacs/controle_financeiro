    ...
    <ul class="row list-unstyled bg-light mt-2">
        <li class="col-12 text-white bg-2 py-3 text-center border-bottom border-dark">
            <div class="d-flex justify-content-between">
                <div class="col-4 fs-mobile">Despesa</div>
                <div class="col-4 fs-mobile">Data de Cadastro</div>
                <div class="col-3 fs-mobile">Ações</div>
            </div>
        </li>
        <?php
        ...
        ?>
            <li class="col-12 text-center">
                <div class="row justify-content-between align-items-center mb-0 py-3 bg-default border-bottom border-dark">
                    <div class="col-4 fs-mobile">
                        <?= $despesa['despesa'] ?>
                    </div>
                    <div class="col-4 fs-mobile">
                        <?= $despesa['data_cadastro'] ? formataData($despesa['data_cadastro']) : '' ?>
                    </div>
                    <div class="col-3 fs-mobile">
                        <a href="<?= SITE ?>tipos_de_despesas&cod=<?= $despesa['id'] ?>" class="fs-4 text-secondary"><i class="fa-solid fa-pen-to-square"></i></a>
