    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-end pb-3">
                <div class="col-2 pe-2 col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-4 col-4"><a href="<?= SITE ?>cadastro_receitas" class="btn btn-success btn-add w-100">Nova Receita</a></div>
                <div class="col-2 pe-2 col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-4 col-4"><a href="<?= SITE ?>tipos_de_receitas" class="btn btn-primary btn-add w-100">Nova Categoria</a></div>
                <div class="col-2 col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-4 col-4"><a href="<?= SITE ?>listar_tipos_de_receitas" class="btn btn-primary btn-add w-100">Listar Categorias</a></div>
            </div>
        </div>
        <form action="<?= SITE ?>receitas" method="GET" class="d-flex align-items-center text-white flex-xxl-row flex-xl-row flex-lg-row flex-md-row flex-sm-column flex-column">
    ...
    <ul class="row list-unstyled bg-light mt-2">
        <li class="col-12 text-white bg-2 py-3 text-center border-bottom border-dark">
            <div class="row justify-content-between fs-mobile">
                <div class="col-4">Receitas</div>
                <div class="col-2">Valor</div>
                <div class="col-3">Lançamento</div>
        ...
        ?>
            <li class="col-12 text-center">
                <div class="row justify-content-between align-items-center mb-0 py-3 bg-green border-bottom border-dark fs-mobile">
                    <div class="col-4">
                        <?= $receita['receita'] ?>
                    </div>
                    <div class="col-2">
